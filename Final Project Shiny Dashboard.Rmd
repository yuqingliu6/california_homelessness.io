...
DemoValue3 = homeless_data |> distinct(HospitalCounty) |> pull()
...
# homeless_pie =
#   homeless_data |>
#   group_by(HospitalCounty, DemographicValue) |>
#   summarise(total_homelessness = sum(Encounters))
# 
# renderPlotly({
#   homeless_pie |>
#     filter(HospitalCounty == input$DemoValue3) |>
#     plot_ly(label = ~DemographicValue, values = ~total_homelessness, type ="pie") |>
#      layout(title = "Total Homelessness by Different Types of Demographic Parameters",
