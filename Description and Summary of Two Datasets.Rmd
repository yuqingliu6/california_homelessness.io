...
First of all, for convenience, we define a function that automates the process of creating summary table, with the dataset's name as the input:
...
Then, we consider summarizing the population grouped by the following parameters: 
...
homeless_data_for_summary =
  ...
  select(EncounterType, FacilityName, System, Ownership, Urban_Rural, LicensedBedSize, PrimaryCareShortageArea, MentalHealthShortageArea)
