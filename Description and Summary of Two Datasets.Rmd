...
age_clean <- read.csv("cleaned_age_demo.csv")
ethnicity_clean <- read.csv("cleaned_ethnicity_demo.csv")
gender_clean <- read.csv("cleaned_gender_demo.csv")
race_clean <- read.csv("cleaned_race_demo.csv")
```
