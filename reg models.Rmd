...
Yeo-Johnson method applies a transformation by raising `Encounters` to different power, as we can see above, $\lambda$ is close to 0, so we need to do natural logarithm transformation, turn `Encounters` into ln(`Encounters`).
